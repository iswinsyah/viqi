...
<aside id="sidebar" class="bg-emerald-900 text-white w-64 flex-shrink-0 hidden flex md:flex flex-col z-30 transition-all duration-300 absolute md:relative h-full shadow-2xl">
    ...
    <div class="p-4 border-t border-emerald-800 space-y-2">
        <a href="dashboard.php" class="flex items-center justify-center text-sm font-bold text-emerald-950 transition-all bg-amber-400 hover:bg-amber-300 px-4 py-2.5 rounded-lg shadow-sm">

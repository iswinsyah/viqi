            ...
            <!-- FILTER BAR -->
                <div class="mb-4">
                    ...
                    <?php if ($is_locked && count($santri_anak) > 1): ?>
                        <div class="flex items-center gap-2 bg-white px-3 py-2 rounded-2xl border border-teal-100 shadow-xs flex-wrap">
                    ...
                    <?php elseif ($is_locked && !empty($selected_child)): ?>
                        <div class="inline-flex items-center gap-2 bg-teal-50 border border-teal-200 text-teal-900 px-3.5 py-2 rounded-xl text-xs font-bold flex-wrap">
                ...
                <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
                    <input type="hidden" name="santri_id" value="<?= htmlspecialchars($santri_id) ?>">

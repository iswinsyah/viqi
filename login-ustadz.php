...
<body class="bg-gradient-to-br from-[#0b8478]/10 via-slate-50 to-teal-50 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="bg-white/95 backdrop-blur-md p-6 sm:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-teal-100 relative z-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Ruang Asatidz</h1>
            <p class="text-xs text-slate-500 mt-1">Sistem Informasi Akademik & Kinerja • Villa Quran</p>
        </div>
        ...
        <form action="" method="POST" class="space-y-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="username" required autofocus class="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-bold text-slate-800 focus:ring-2 focus:ring-[#0b8478] focus:bg-white focus:outline-none transition" placeholder="Masukkan username asatidz">
                </div>
            </div>
            <div>

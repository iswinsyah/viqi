    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50"><h2 class="font-bold text-gray-800">Riwayat Pembayaran Tervalidasi</h2></div>
                <div class="overflow-x-auto p-4">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            <?php if(empty($data_spp)): ?><tr><td colspan="6" class="text-center py-10 text-gray-400 italic">Belum ada data pembayaran yang tervalidasi.</td></tr><?php else: foreach($data_spp as $r): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-center"><?php if($r['bukti_transfer']): ?><a href="uploads/spp/<?= $r['bukti_transfer'] ?>" target="_blank" class="text-indigo-600 hover:text-indigo-800"><i class="fas fa-image text-lg"></i></a><?php else: ?>-<?php endif; ?></td>

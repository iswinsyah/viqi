...
<head>
    ...
    <title>Seting Gaji | Yayasan 2</title>
...
<body class="bg-gray-100 font-sans antialiased text-gray-800 flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            <div class="mb-6"><h1 class="text-2xl font-bold text-gray-900"><i class="fas fa-money-bill-wave text-emerald-500 mr-2"></i>Pengaturan Gaji Ustadz</h1></div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                <h2 class="font-bold text-gray-800 mb-4 border-b pb-2"><i class="fas fa-file-invoice-dollar text-amber-500 mr-2"></i>Tarif Gaji (Per Pertemuan)</h2>

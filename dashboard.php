...
<body class="bg-[#dcf3ee] min-h-screen text-slate-800 flex flex-col antialiased selection:bg-[#0b8478] selection:text-white">
            ...
            <div class="max-w-4xl mx-auto flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3.5">
                    ...
                    <div class="w-13 h-13 rounded-full bg-white flex items-center justify-center p-1.5 shadow-md flex-shrink-0">
                        <img src="upload/logo-villa-quran.png" alt="Logo Villa Quran" class="w-10 h-10 object-contain">
                    </div>
        ...
        <main class="flex-1 px-4 sm:px-8 pt-0 pb-24 md:pb-12 w-full max-w-4xl mx-auto -mt-14 z-20">
            ...
            <div class="bg-white rounded-[32px] md:rounded-[36px] p-6 sm:p-8 shadow-xl shadow-teal-950/5 border border-teal-50 mt-6 sm:mt-7 transition-all duration-200 relative overflow-hidden">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 mb-6 pb-3 border-b border-teal-100/70 relative z-10">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center gap-1.5 text-[10px] font-bold text-teal-800 bg-teal-50/90 px-3.5 py-1.5 rounded-xl border border-teal-200/80 shadow-xs">
    ...
    <?php include 'bottombar-universal.php'; ?>
</body>
</html>

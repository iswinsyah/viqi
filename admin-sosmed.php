...
<body class="bg-gray-100 font-sans antialiased text-gray-800 flex h-screen overflow-hidden">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 h-full min-h-[500px] flex flex-col overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button id="btn-save-as" onclick="simpanSebagai()" class="hidden bg-pink-100 text-pink-700 hover:bg-pink-200 px-3 py-1.5 rounded-lg text-xs font-bold transition shadow-sm border border-pink-200"><i class="fas fa-file-download mr-1"></i> Save As</button>
    ...
    <script>
        ...
        function simpanSebagai() {
            ...
            a.href = url;
            const tgl = document.getElementById('tgl-sosmed').value || new Date().toISOString().slice(0,10);
            a.download = `Konten_Sosmed_${tgl}.md`;

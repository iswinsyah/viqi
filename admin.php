        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-4 sm:p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-500">Total Santri Aktif</p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-500">Artikel Blog</p>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-medium text-gray-900">Muhammad Al-Fatih</div>
                                    <div class="text-sm text-gray-500">SMP (Putra)</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Bandung, Jawa Barat</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">24 Okt 2026</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-medium text-gray-900">Aisyah Zahra</div>
                                    <div class="text-sm text-gray-500">SMA (Putri)</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Jakarta Selatan</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">23 Okt 2026</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-medium text-gray-900">Ustadz Budi</div>
                                    <div class="text-sm text-gray-500">0812-9999-8888</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 bg-gray-100 text-gray-700 rounded font-mono text-sm border border-gray-200">UstadzBudi</span>
                                </td>
